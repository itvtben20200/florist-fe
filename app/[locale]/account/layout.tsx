...
export default function AccountLayout({ children }: { children: React.ReactNode }) {
  ...
  const customerNavItems = [
    { href: '/account', label: t('dashboard'), icon: '🏠' },
    { href: '/account/orders', label: t('orderHistory'), icon: '📦' },
    { href: '/account/profile', label: t('myProfile'), icon: '👤' },
    { href: '/account/security', label: t('passwordSecurity'), icon: '🔒' },
  ];
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <aside className="lg:w-64 flex-shrink-0">
          ...
          <div className="bg-white border rounded-xl p-5 mb-4">
            ...
            <p className="font-semibold leading-tight">{user.name ?? t('myAccount')}</p>
